...
namespace pul
{
	...
	public:
		/// Constructors
		pf_decl_inline
		__dbg_wsstring_view() pf_attr_noexcept
			: count_(0)
			, store_(nullptr)
		{}
		pf_decl_inline
	...
	public:
		...
		/// Constructors
		pf_decl_inline
		__dbg_wsstring() pf_attr_noexcept
			: count_(0)
			, store_(nullptr)
		{}
		pf_decl_inline
	...
	public:
		...
		/// Operator =
		__dbg_internal_t &
		operator=(__dbg_internal_t const &) = delete;
		__dbg_internal_t &
		operator=(__dbg_internal_t &&) = delete;

		/// Retrieve
		pf_hint_nodiscard __dbg_record_win_t *
