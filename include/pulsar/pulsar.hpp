...
// C++20 is required!
#if !defined(__cplusplus) || __cplusplus < 202'002L
...
#define pf_alignas_n(type, a)				pf_alignas(alignof(type) * a > 32 ? 32 : (alignof(type) * a < 16 ? 16 : alignof(type) * a))
#define pf_alignof(type)						align_val_t(alignof(type))
