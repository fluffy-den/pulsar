...
namespace pul
{
	...
	namespace math
	{
		...
		public:
			...
			/// Operator[]
			pf_decl_constexpr row_vector<_Ty, _ColNum, SIMD_UNALIGNED> &operator[](
					size_t __index) pf_attr_noexcept
			{
				return this->store_[__index];
			}
			pf_decl_constexpr const row_vector<_Ty, _ColNum, SIMD_UNALIGNED> &operator[](
			...
			/// Operator+=
			template <simd_align_t _RSIMD>
			pf_decl_constexpr matrix<_Ty, _RowNum, _ColNum, _SIMD> &operator+=(
					matrix<_Ty, _RowNum, _ColNum, _RSIMD> const &__r) pf_attr_noexcept
			{
				for (size_t i = 0; i < _RowNum; ++i)
				{
			...
			/// Compare
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_constexpr matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> vals_equal(
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_constexpr matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> vals_greater(
					matrix<_Ty, _RowNum, _ColNum, _RSIMD> const &__r) const pf_attr_noexcept
			{
				matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> tmp;
				for (size_t i = 0; i < _RowNum; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_constexpr matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> vals_greater_equal(
					matrix<_Ty, _RowNum, _ColNum, _RSIMD> const &__r) const pf_attr_noexcept
			{
				matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> tmp;
				for (size_t i = 0; i < _RowNum; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_constexpr matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> vals_smaller(
					matrix<_Ty, _RowNum, _ColNum, _RSIMD> const &__r) const pf_attr_noexcept
			{
				matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> tmp;
				for (size_t i = 0; i < _RowNum; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_constexpr matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> vals_smaller_equal(
					matrix<_Ty, _RowNum, _ColNum, _RSIMD> const &__r) const pf_attr_noexcept
			{
				matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> tmp;
				for (size_t i = 0; i < _RowNum; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_constexpr matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> vals_not_equal(
					matrix<_Ty, _RowNum, _ColNum, _RSIMD> const &__r) const pf_attr_noexcept
			{
				matrix<bool, _RowNum, _ColNum, simd_select_v<bool, _ColNum>> tmp;
				for (size_t i = 0; i < _RowNum; ++i)
			...
			/// Num of Row
			pf_hint_nodiscard pf_decl_static pf_decl_constexpr size_t num_row_elem() pf_attr_noexcept
			{
				return _RowNum;
			}

			/// Num of Col
			pf_hint_nodiscard pf_decl_static pf_decl_constexpr size_t num_col_elem() pf_attr_noexcept
			{
				return _ColNum;
			}
		...
		pf_hint_nodiscard pf_decl_constexpr matrix<_Ty, _Num, _Num, _SIMD> identity(
		...
		pf_hint_nodiscard pf_decl_constexpr _SquareMat identity(
		...
		pf_hint_nodiscard pf_decl_constexpr matrix<_Ty, _RowNum, _ColNum, simd_select_v<_Ty, _ColNum>> operator+(
		...
		/// MATH: Matrix -> Operator*
		template <typename _Ty, size_t _RowNum, size_t _ColNum, simd_align_t _SIMD>
		pf_hint_nodiscard pf_decl_constexpr matrix<_Ty, _RowNum, _ColNum, _SIMD> operator*(
		...
		pf_hint_nodiscard pf_decl_constexpr matrix<_Ty, _LRowNum, _RColNum, simd_select_v<_Ty, _LColNum>> operator*(
		...
		pf_hint_nodiscard pf_decl_constexpr matrix<_Ty, _LNum, _RNum, simd_select_v<_Ty, _RNum>> operator*(
		...
		template <typename _Ty, size_t _LNum, simd_align_t _LSIMD, size_t _RNum, simd_align_t _RSIMD>
		pf_hint_nodiscard pf_decl_constexpr row_vector<_Ty, _RNum, simd_select_v<_Ty, _RNum>> operator*(
		...
		template <typename _Ty, size_t _LNum, simd_align_t _LSIMD, size_t _RNum, simd_align_t _RSIMD>
		pf_hint_nodiscard pf_decl_constexpr col_vector<_Ty, _LNum, simd_select_v<_Ty, _LNum>> operator*(
