...
namespace pul
{
	...
	namespace math
	{
		...
		union alignas(simd_alignment_of_v<_Ty, 2, _SIMD>) col_vector<_Ty, 2, _SIMD> pf_attr_final
		{
			...
			/// Operator+=
			template <simd_align_t _RSIMD>
			pf_decl_inline pf_decl_constexpr col_vector<_Ty, 2, _SIMD> &operator+=(
					col_vector<_Ty, 2, _RSIMD> const &__r) pf_attr_noexcept
			{
				this->x += __r.x;
				this->y += __r.y;
			...
			/// Compare
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, 2> vals_equal(
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, 2, simd_select_v<bool, 2>> vals_greater(
					col_vector<_Ty, 2, _RSIMD> const &__r) const pf_attr_noexcept
			{
				return col_vector<bool, 2, simd_select_v<bool, 2>>(
						this->x > __r.x,
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, 2, simd_select_v<bool, 2>> vals_greater_equal(
					col_vector<_Ty, 2, _RSIMD> const &__r) const pf_attr_noexcept
			{
				return col_vector<bool, 2, simd_select_v<bool, 2>>(
						this->x >= __r.x,
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, 2, simd_select_v<bool, 2>> vals_smaller(
					col_vector<_Ty, 2, _RSIMD> const &__r) const pf_attr_noexcept
			{
				return col_vector<bool, 2, simd_select_v<bool, 2>>(
						this->x < __r.x,
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, 2, simd_select_v<bool, 2>> vals_smaller_equal(
					col_vector<_Ty, 2, _RSIMD> const &__r) const pf_attr_noexcept
			{
				return col_vector<bool, 2, simd_select_v<bool, 2>>(
						this->x <= __r.x,
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, 2, simd_select_v<bool, 2>> vals_not_equal(
					col_vector<_Ty, 2, _RSIMD> const &__r) const pf_attr_noexcept
			{
				return col_vector<bool, 2, simd_select_v<bool, 2>>(
						this->x != __r.x,
