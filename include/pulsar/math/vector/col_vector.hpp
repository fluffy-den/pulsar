...
namespace pul
{
	...
	namespace math
	{
		...
		public:
			...
			/// Operator+=
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<_Ty, _Num, _SIMD> &operator+=(
					col_vector<_Ty, _Num, _RSIMD> const &__r) pf_attr_noexcept
			{
			...
			/// Operator-=
			template <simd_align_t _RSIMD>
			pf_decl_inline pf_decl_constexpr col_vector<_Ty, _Num, _SIMD> &operator-=(
					col_vector<_Ty, _Num, _RSIMD> const &__r) pf_attr_noexcept
			{
				for (size_t i = 0; i < _Num; ++i)
				{
			...
			/// Compare
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, _Num, simd_select_v<bool, _Num>> vals_equal(
					col_vector<_Ty, _Num, _RSIMD> const &__r) const pf_attr_noexcept
			{
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, _Num, simd_select_v<bool, _Num>> vals_greater(
					col_vector<_Ty, _Num, _RSIMD> const &__r) const pf_attr_noexcept
			{
				col_vector<bool, _Num, simd_select_v<bool, _Num>> tmp;
				for (size_t i = 0; i < _Num; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, _Num, simd_select_v<bool, _Num>> vals_greater_equal(
					col_vector<_Ty, _Num, _RSIMD> const &__r) const pf_attr_noexcept
			{
				col_vector<bool, _Num, simd_select_v<bool, _Num>> tmp;
				for (size_t i = 0; i < _Num; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, _Num, simd_select_v<bool, _Num>> vals_smaller(
					col_vector<_Ty, _Num, _RSIMD> const &__r) const pf_attr_noexcept
			{
				col_vector<bool, _Num, simd_select_v<bool, _Num>> tmp;
				for (size_t i = 0; i < _Num; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, _Num, simd_select_v<bool, _Num>> vals_smaller_equal(
					col_vector<_Ty, _Num, _RSIMD> const &__r) const pf_attr_noexcept
			{
				col_vector<bool, _Num, simd_select_v<bool, _Num>> tmp;
				for (size_t i = 0; i < _Num; ++i)
			...
			template <simd_align_t _RSIMD>
			pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<bool, _Num, simd_select_v<bool, _Num>> vals_not_equal(
					col_vector<_Ty, _Num, _RSIMD> const &__r) const pf_attr_noexcept
			{
				col_vector<bool, _Num, simd_select_v<bool, _Num>> tmp;
				for (size_t i = 0; i < _Num; ++i)
		...
		pf_hint_nodiscard pf_decl_inline pf_decl_constexpr col_vector<_Ty, _Num, simd_select_v<_Ty, _Num>> operator+(
