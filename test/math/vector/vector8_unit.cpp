...
namespace pul
{
	...
	TEST_CASE("MathInt32Vec8Test1")
	{
		...
		const int32_t i1 = r(gen), i2 = r(gen), i3 = r(gen),
									...
									i7 = r(gen), i8 = r(gen);
		vector<int32_t, 8, SIMD_UNALIGNED> v1 = { i1, i2, i3, i4, i5, i6, i7, i8 };
		REQUIRE(i1 == v1[0]);
		REQUIRE(i2 == v1[1]);
		REQUIRE(i3 == v1[2]);
		REQUIRE(i4 == v1[3]);
		...
		REQUIRE(i8 == v1[7]);
		// Assignment
		vector<int32_t, 8, SIMD_ALIGNED> v2;
		v2 = v1;
		REQUIRE(i1 == v2[0]);
		REQUIRE(i2 == v2[1]);
		REQUIRE(i3 == v2[2]);
	...
	TEST_CASE("MathInt32Vec8Test2")
	{
		...
		std::uniform_int_distribution<int32_t> r(
				std::numeric_limits<int32_t>::min(),
				std::numeric_limits<int32_t>::max());
		vector<int32_t, 8, SIMD_UNALIGNED> v1 = {
			r(gen),
			r(gen),
			r(gen),
			r(gen),
