...
namespace pul
{
	...
	{
		// pt_benchmark(push_lifo_t1, __bvn, 4096, 1)
		// {
		// 	mpsc_singly_lifo<size_t> msl;
		// 	mpsc_singly_lifo<size_t>::node_t *nodes = new_construct_array<mpsc_singly_lifo<size_t>::node_t>(__bvn.num_iterations());
		// 	__bvn.measure([&](size_t __index)
		// 	{
		...
		// }
		// pt_benchmark(push_lifo_t2, __bvn, 4096, 2)
		// {
		// 	mpsc_singly_lifo<size_t> msl;
		// 	mpsc_singly_lifo<size_t>::node_t *nodes = new_construct_array<mpsc_singly_lifo<size_t>::node_t>(__bvn.num_iterations());
		// 	__bvn.measure([&](size_t __index)
		...
		// 	destroy_delete_array(nodes);
		// }
		// pt_benchmark(push_lifo_t4, __bvn, 4096, 4)
		// {
		// 	mpsc_singly_lifo<size_t> msl;
		// 	mpsc_singly_lifo<size_t>::node_t *nodes = new_construct_array<mpsc_singly_lifo<size_t>::node_t>(__bvn.num_iterations());
		// 	__bvn.measure([&](size_t __index)
		...
		// 	destroy_delete_array(nodes);
		// }
		// pt_benchmark(push_lifo_t8, __bvn, 4096, 8)
		// {
		// 	mpsc_singly_lifo<size_t> msl;
		// 	mpsc_singly_lifo<size_t>::node_t *nodes = new_construct_array<mpsc_singly_lifo<size_t>::node_t>(__bvn.num_iterations());
		// 	__bvn.measure([&](size_t __index)
		...
		// 	destroy_delete_array(nodes);
		// }
		// pt_benchmark(pop_lifo_t1, __bvn, 4096, 1)
		// {
		// 	mpsc_singly_lifo<size_t> *msl					= new_construct_array<mpsc_singly_lifo<size_t>>(65536);
		// 	mpsc_singly_lifo<size_t>::node_t *msn = new_construct_array<mpsc_singly_lifo<size_t>::node_t>(CCY_NUM_THREADS * 65536);
		...
		// 	});
		// 	destroy_delete_array(msl);
		// 	destroy_delete_array(msn);
		// }
		// pt_benchmark(pop_empty_lifo_t8, __bvn, 4096, 8)
		// {
		// 	mpsc_singly_lifo<size_t> msl;
		// 	__bvn.measure([&](size_t __index)
		// 	{
	...
	// MPMC Queue
	pt_pack(mpmc_lifo_pack)
	{
		// pt_benchmark(push_t1, __bvn, 65536, 1)
		// {
		// 	mpmc_lifo<size_t> queue(65536 * 16);

		// 	size_t *buf = new_construct_array<size_t>(65536);
		// 	for (size_t i = 0; i < 65536; ++i)
		// 	{
		// 		buf[i] = i;
		// 	}
		...
		// }
		// pt_benchmark(push_t2, __bvn, 65536, 2)
		// {
		// 	mpmc_lifo<size_t> queue(65536 * 4);

		// 	size_t *buf = new_construct_array<size_t>(65536 * 2);
		...
		// 	destroy_delete_array(buf);
		// }
		// pt_benchmark(push_t4, __bvn, 65536, 4)
		// {
		// 	mpmc_lifo<size_t> queue(65536 * 8);

		// 	size_t *buf = new_construct_array<size_t>(65536 * 4);
		...
		// 	destroy_delete_array(buf);
		// }
		// pt_benchmark(push_t8, __bvn, 65536, 8)
		// {
		// 	mpmc_lifo<size_t> queue(65536 * 16);

		// 	size_t *buf = new_construct_array<size_t>(65536 * 8);
		...
		// {
		// 	mpmc_lifo<size_t> queue(262144 * 2);

		// 	size_t *buf = new_construct_array<size_t>(262144);
		...
		// {
		// 	mpmc_lifo<size_t> queue(262144 * 4);

		// 	size_t *buf = new_construct_array<size_t>(262144 * 2);
		...
		// {
		// 	mpmc_lifo<size_t> queue(262144 * 8);

		// 	size_t *buf = new_construct_array<size_t>(262144 * 4);
		...
		// {
		// 	mpmc_lifo<size_t> queue(262144 * 16);

		// 	size_t *buf = new_construct_array<size_t>(262144 * 8 + 1);
	...
	pt_pack(mpmc_lifo2_pack)
	{
		...
		// {
		// 	mpmc_lifo2<size_t> queue(262144 * 2);
		...
		// {
		// 	mpmc_lifo2<size_t> queue(262144 * 4);
		...
		// {
		// 	mpmc_lifo2<size_t> queue(262144 * 8);
		...
		// {
		// 	mpmc_lifo2<size_t> queue(262144 * 16);
		...
		// 	size_t *buf = new_construct_array<size_t>(262144 * 8);
		// 	for (size_t i = 0; i < 262144 * 8; ++i)
		// 	{
		// 		buf[i] = i;
		// 	}
		...
		// {
		// 	mpmc_lifo2<size_t> queue(262144);
		// 	__bvn.measure([&](size_t __index)
		// 	{
		// 		ignore = __index;
		// 		return queue.try_dequeue();
	...
	// mamd Ring Allocator
	pt_pack(allocator_mamd_ring_buffer_pack)
	{
		// // Unit
		// pt_unit(mamd_ring_allocator_unicity)
		// {
		// 	allocator_mamd_ring_buffer all(65536);
		...
		// // Benchmarks
		// pt_benchmark(mamd_ring_deal_t1, __bvn, 262144, 1)
		// {
		// 	allocator_mamd_ring_buffer all(2ull * 262144 * (64 + 8));
		...
		// 	hfree(buf);
		// }
		// pt_benchmark(mamd_ring_all_and_deal_t1, __bvn, 262144, 1)
		// {
		// 	allocator_mamd_ring_buffer all(2ull * 262144 * (64 + 8));
		// 	__bvn.measure([&](size_t __index)
		// 	{
		...
		// 	});
		// }
		// pt_benchmark(mamd_ring_deal_t2, __bvn, 262144, 2)
		// {
		// 	allocator_mamd_ring_buffer all(4ull * 262144 * (64 + 8));
		...
		// 	hfree(buf);
		// }
		// pt_benchmark(mamd_ring_deal_t8, __bvn, 262144, 8)
		// {
		// 	allocator_mamd_ring_buffer all(16ull * 262144 * (64 + 8));
